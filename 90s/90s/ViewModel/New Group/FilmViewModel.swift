...
class FilmsViewModel {
    ...
    func getStateData(state : FilmStateType) -> Observable<[Film]>{
        return self.FilmObservable.map {
    ...
    func setObservableDefaultData(){
        let filmArray = [
            Film(id: "0", name: "필름 만들기", completeDate: "2021.10.10", filterType: .Create, photos: BehaviorRelay<[Photo]>(value: [
