...
struct FilmFactory {
    func createDefaultData() -> [Film] {
        return [
            Film(uid: 0, name: "필름 만들기", filmType: .init(uid: 0, code: 0, name: .Create), photos: [
            ...
            Film(uid: 2, name: "귀여운 필름", filmType: .init(uid: 1, code: 0, name: .Cute), photos: [
            ...
            Film(uid: 2, name: "멋있는 필름", filmType: .init(uid: 3, code: 0, name: .Nice), photos: [
            ...
            Film(uid: 3, name: "차가운 필름", filmType: .init(uid: 1, code: 0, name: .Cold), photos: [
                Photo(photoUid: 9, url: "test_pic4", date: "\(Date())"),
                Photo(photoUid: 10, url: "test_pic4", date: "\(Date())")
            ], maxCount: 36, state: .printing),
            Film(uid: 4, name: "차분한 필름", filmType: .init(uid: 5, code: 0, name: .Dandy), photos: [
            ...
            Film(uid: 5, name: "강렬한 필름", filmType: .init(uid: 4, code: 0, name: .Hot), photos: [
            ...
            Film(uid: 6, name: "귀여운 필름", filmType: .init(uid: 2, code: 0, name: .Cute), photos: [], maxCount: 36, state: .adding)
        ]
    }
}
