...
struct FilmFactory {
    func createDefaultData() -> [Film] {
        return [
            ...
            Film(uid: 4, name: "차분한 필름", filmType: .init(uid: 5, code: 0, name: .ForgetMeNot, createdAt: Date().toString), printStartAt: Date().toString, photos: [
            ...
            Film(uid: 6, name: "귀여운 필름", filmType: .init(uid: 2, code: 0, name: .ForgetMeNot, createdAt: Date().toString), photos: [], maxCount: 36)
        ]
    }
}
